...
public class LocalCallProvider extends Provider {
	...
	/* (non-Javadoc)
	 * @see com.shc.crossing.bservice.provider.Provider#init()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see com.shc.crossing.bservice.provider.Provider#execute(java.lang.String, java.lang.String, java.lang.String, java.lang.String, boolean)
	 */
	@Override
