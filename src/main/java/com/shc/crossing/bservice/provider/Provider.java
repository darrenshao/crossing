...
public abstract class Provider implements IProvider {
	...
	/* (non-Javadoc)
	 * @see com.shc.crossing.bservice.provider.IProvider#init()
	 */
	...
	/* (non-Javadoc)
	 * @see com.shc.crossing.bservice.provider.IProvider#execute(java.lang.String, java.lang.String, java.lang.String, java.lang.String, boolean)
	 */
	...
	/* (non-Javadoc)
	 * @see com.shc.crossing.bservice.provider.IProvider#getName()
	 */
	...
	/* (non-Javadoc)
	 * @see com.shc.crossing.bservice.provider.IProvider#getClazz()
	 */
	...
	/* (non-Javadoc)
	 * @see com.shc.crossing.bservice.provider.IProvider#isEnabled()
	 */
